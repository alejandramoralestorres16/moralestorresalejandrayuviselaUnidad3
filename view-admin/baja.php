...
<header>
 ...
 <a class="nav-link" href="admin.php"  style="color: white"> <i class="fas fa-home"></i> . </a> </strong>
  ...
  <li>   <strong>
 <a class="nav-link" href="eliminaralumno.php" style="color: red">Eliminar del sistema</a>   </strong>
          </li>
          <li class="nav-item">   
...
<form action="documentoDeBaja.php" method="post">
<div class="login-page">
  <div class="form">
     <form action="documentoDeBaja.php" method="post" class="login-form">
   
 <img src="img/logo.png"height="50"alt=""loading="lazy"/>
<br><br>
   
    
     <input type="number" name="matricula" placeholder="Matricula" value="" />
      <input type="text" name="nombre" placeholder="Nombre del alumno" value="" />
      <input type="text" name="grupo" placeholder="Grupo" value="" />
      <textarea name="motivo" rows="5" cols="35" placeholder="Motivo de Baja"></textarea>
...
<button type="submit" class="btn btn-outline-lime" data-mdb-ripple-color="dark">IMPRIMIR </button>
