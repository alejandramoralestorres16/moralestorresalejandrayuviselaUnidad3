...
<html>
<head>
  <title>||Eliminar del sistema </title>
...
<center>
<h2><span class="badge" style="background-color:#E50404 ;color: white">ELIMINAR DEL SISTEMA</span></h2>
</center>
...
<div class="login-page">
  <div class="form">
      ...
      <input type="matricula" name="matricula" placeholder="Matricula"  
        value="<?php if (isset($_POST['buscar'])) echo $campo['matricula'] ?>" />
   
      <br>
       <a href="index.html"> <button type="submit" name= "eliminar"style="background-color: red">BAJA DEFINITIVA</button></a>
