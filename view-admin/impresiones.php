...
<header>
 ...
 <nav style="background: #b3ae11" class="navbar navbar-expand-lg  bg-dark navbar-dark text-uppercase fixed-top">
  ...
  <li class="nav-item">   <a class="nav-link" style="color: white;"><i class="fas fa-user">
...
<br> <br><br><br><br>
  ...
  <div class="row">
    <div class="col">
      ...
      <a href="imprimir_lista.php"><img
        src="img/listasg.png" width="50" height="300"
        class="card-img-top"
      

      />
     <div class="text-center">
        <h5 class="card-title"style="margin-top: 10px;color: white;">Listas de Grupos</h5>
    ...
    <div class="col">
      ...
      />
     <div class="text-center">
        <h5 class="card-title" style="margin-top: 10px;color: white;">Listas Finales</h5>
    ...
    <div class="col">
       <div class="card text-white bg-dark">
      <a href="directorio.php"><img
       src="img/directorio.png"
        class="card-img-top"
        width="50" height="300"

      />
     <div class="text-center">
        <h5 class="card-title"style="margin-top: 10px; color: white;">Directorio Telefonico</h5>
    ...
    <div class="col">
      ...
      />
     <div class="text-center">
        <h5 class="card-title"style="margin-top: 10px; color: white;">Subir datos</h5>
