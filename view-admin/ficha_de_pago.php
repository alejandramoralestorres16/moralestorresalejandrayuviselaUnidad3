<?php
    ...
    if (isset($_POST['generar'])) {
        ...
        $sql=$cnnPDO->prepare("SELECT * from alumnos WHERE matricula=:matricula");
        ...
        $sql->execute();
            ...
            if ($count) {
                ...
                //print"<script>window.location='../imprimir.php';</script>";
            } else {
                echo "<br><br><center>
    <div class='card text-white bg-danger mb-3' style='max-width: 30rem;'>
    <div class='card-header'><h3>MATRICULA NO ENCONTRADA</h3></div>
    </div>
...
<html>
<head>
  <title>Conalep II | Ficha de pago </title>
...
<br>   
<button type="submit" name="generar" style="color: white; border-color: black; background-color: red" class="btn btn-outline-dark btn-fluid">GENERAR FICHA DE PAGO </button>
<br><br>
<h2>PRORROGA</h2>
<button type="button" style="color: white; border-color: black; background-color: red" class="btn btn-outline-dark btn-fluid"><a href="prorroga.php" style="color:white">SOLICITAR PRORROGA </button></a>
<br>
<a href="prorrogas.php" style="color:black;">ver prorrogas</a>
    </form>
  </div>
  <!-- MDB -->
