...
<meta charset="UTF-8" />
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
    <!-- MDB icon -->
    <link rel="icon" href="img/cobac.png" type="image/x-icon" />
    <!-- Font Awesome -->
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.11.2/css/all.css" />
    <!-- Google Fonts Roboto -->
    <link
...
<form action="documentoDereporte.php" method="post">
<div class="login-page">
  <div class="form">
     <form action="documentoDereporte.php" method="post" class="login-form">
...
<br><br>
     ...
     <input type="text" name="matricula" placeholder="Matricula" value=""/>
      ...
      <input type="text" name="maestro" placeholder="Maestro" value=""/>
      <textarea name="motivo" rows="5" cols="35" placeholder="Motivo de indisiplina"></textarea>
   
      <br> <br>
<button type="submit" name="reporte" class="btn btn-outline-lime" data-mdb-ripple-color="dark">GENERAR </button>
