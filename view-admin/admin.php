...
<!-- Columns start at 50% wide on mobile and bump up to 33.3% wide on desktop -->
  <div class="row">
    ...
    <div class="card text-white bg-danger">
      <a href="agregarRiesgoAlu.php"><img
        src="img/riesgo.png" width="50" height="200"
        class="card-img-top"
...
<ul class="navbar-nav mr-auto">
    ...
    <div class="card text-white bg-warning">
      <a href="accionesdealumnos.php"><img
        src="img/alumnoss.png"
        class="card-img-top"
        width="50" height="200"
    ...
    <div class="col-6 col-md-4">
      ...
      <a href="editaralumno.php"><img
        src="img/edito.png" width="50" height="200"
        class="card-img-top"
      

      />
     <div class="text-center">
        <h5 class="card-title"style="margin-top: 10px; color: white;">Editar Alumno</h5>
  ...
  <div class="row">
    <div class="col-6 col-md-4">
      ...
      <div class="text-center">
         ...
         <h5 class="card-title"style="margin-top: 10px;color: white;">Alumno de Nuevo Ingreso</h5>
      </div></a>
    </div>
    </div>
    <div class="col-6 col-md-4">
     <div class="card text-white bg-warning">
      <a href="eliminaralumno.php"><img
        src="img/borra.png"
        class="card-img-top"
      width="50" height="200"
      ...
      />
      <div class="text-center">
        <h5 class="card-title"style="margin-top: 10px; color:white; ">Eliminar Alumno del Sistema</h5>
