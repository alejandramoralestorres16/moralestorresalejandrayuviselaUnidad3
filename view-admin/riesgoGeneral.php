...
<head>
  <head>
  <title>COBAC || Alumnos en riesgo </title>
    ...
    <?php   
     ...
     <?php    } ?>
           ...
           <button class="btn btn-outline-lime btn-rounded btn-block z-depth-0 my-4 waves-effect" type="submit" name= "buscar">BUSCAR <i class="fas fa-search"></i></button>
            ...
            <a href="riesgoGrupal.php">BUSCAR POR GRUPO </a>
            <!-- Send button -->
...
$f2=$_POST['f2'];
?>
     <center>  <h3 class=" text-dark font-weight-bold" >REPORTE DE ALUMNOS EN RIESGO GENERAL  </h3> 
    ...
    <table class="table table-striped table-bordered border-dark bg-white">
      ...
      <tbody>
        <?php   
$v = mysqli_query($link,"SELECT * FROM riesgo WHERE fecha BETWEEN '$f1' AND '$f2'AND grupo");
