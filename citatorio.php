...
<form action="documentoDecitatorio.php" method="post">
<div class="login-page">
  <div class="form">
     <form action="documentoDecitatorio.php" method="post" class="login-form">
   
 <img src="img/logo.png"height="50"alt=""loading="lazy"/>
<br><br>
   
      
     <input type="text" name="madre" placeholder="Madre del alumno" value="" />
      <input type="text" name="padre" placeholder="Padre del alumno" value="" />   
     <input type="text" name="matricula" placeholder="Matricula del alumno" value="" />
      ...
      <input type="text" name="grupo" placeholder="Grupo del alumno" value="" />
      <textarea name="fecha" rows="3" cols="35" placeholder="fecha que se cito a los padres de familia (ej. Viernes, 19 de mayo del 2023"></textarea>
      <br>
       <textarea name="hora" rows="2" cols="35" placeholder="hora que se cito a los padres de familia (ej. 10:00 am "></textarea>
...
<button type="submit" name="registrar" class="btn btn-outline-lime btn-fluid" data-mdb-ripple-color="dark">GENERAR </button>
