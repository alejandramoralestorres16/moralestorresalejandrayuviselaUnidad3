...
<header>
 ...
 <nav style="background: #b3ae11" class="navbar navbar-expand-lg bg-dark navbar-dark  text-uppercase fixed-top">
  ...
  <li class="nav-item">   <a class="nav-link" style="color: white;"><i class="fas fa-user"></i>  </a>
  </li>  
 ...
 <a class="nav-link" href="../admin.php"  style="color: white"> <i class="fas fa-home"></i> . </a> </strong>
   ...
   <li class="nav-item">   
 <a class="nav-link" href="logout.php" onclick="cerrarSesion()" style="color: white"><i class="fas fa-sign-out-alt"></i> . </a> </strong>
  </li>
                </ul>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="panel panel-lime">
                <div class="panel-heading">Importar de datos a la BD</div>
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <a href="../excel/subir.php" class="btn btn-lime ">Cancelar</a>
                        <p id="respuesta">
...
<script>
    $('#btn_lectura').click(function () {
        ...
        $('#my_file_output tr').each(function () {
            ...
            console.log (valor);
           // alert(valor);
            $.post('../excel/insertar.php', {d1:d1, d2:d2, d3:d3, d4:d4, d5:d5, d6:d6, d7:d7, d8:d8, d9:d9, d10:d10, d11:d11, d12:d12, d13:d13}, function (datos) {
